...
class ToolBlockedError(RuntimeError):
    """A tool request was rejected by an execution policy."""
...
class WorkspaceToolset:
    """Read, search, edit, and inspect one explicitly configured workspace."""
                ...
                parameters=self._schema(
                    {
                        ...
                        "pattern": {
                            "type": "string",
                            "description": "可选 glob，例如 *.py 或 production_agent/*.py。",
                        },
                        "max_results": {
                            "type": "integer",
                            "minimum": 1,
