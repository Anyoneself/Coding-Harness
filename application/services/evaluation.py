...
from .local_agent import AgentService
...
DEFAULT_EVALUATION_CASES = [
    ...
    EvaluationCase(
        ...
        request="请检索项目规划模板",
        role="standard",
        expected_intents=("knowledge_search",),
        expected_status="completed",
    ),
    ...
    EvaluationCase(
        ...
        split="regression",
        request="请核验结论并说明引用来源",
        role="standard",
        expected_intents=("analysis",),
        expected_status="completed",
        expected_sources=("guides/conclusion-verification.md",),
    ),
]
